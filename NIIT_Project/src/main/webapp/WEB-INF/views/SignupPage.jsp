...
<div align="center">
<h2>SIGN UP HERE !!...</h2>
<form:form action="Welcome" method="post" modelAttribute="user" style="width:28%; height:50%; border:5px solid black; background-color:#d1f6fc; padding: 5% 5% 5% 5%; margin-top: 4%; margin-bottom:4%;border-radius: 5%">
<table>
...
<tr><td><form:label path="occ">OCCUPATION</form:label></td><td>:</td>
    <td><form:select path="occ">
...
<table>
<tr><td><input type="submit" value="SIGN UP" /></td><td><input type="reset" value="CLEAR" /></td></tr>
</table>
</form:form>
</div>
</body>
